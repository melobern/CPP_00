...
/*   Updated: 2024/07/27 19:18:24 by mbernard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    PhoneBook::private_displayContact(int index) {
    std::cout << "First Name \t:\t" << this->d_contacts[index].getFirstname();
    std::cout << std::endl;
    std::cout << "Last Name \t:\t" << this->d_contacts[index].getLastname();
    std::cout << std::endl;
    std::cout << "Nickname \t:\t" << this->d_contacts[index].getNickname();
    std::cout << std::endl;
    std::cout << "Phone Number \t:\t" << this->d_contacts[index].getPhone();
    std::cout << std::endl;
    std::cout << "Darkest Secret \t:\t" << this->d_contacts[index].getSecret();
    std::cout << std::endl;
}
